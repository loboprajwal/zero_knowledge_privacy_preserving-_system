...
pub fn generate_education_proof(
    ...
    prover::generate_education_proof_internal(
        degree_code,
        credential_status,
        &user_secret,
        required_degree_code,
        &session_nonce,
    )
}

pub fn verify_education_proof(proof_json: String, verification_key: String) -> Result<bool, String> {
    verifier::verify_education_proof_internal(&proof_json, &verification_key)
}
...
#[no_mangle]
pub extern "C" fn ffi_generate_education_proof(
    degree_code: u32,
    credential_status: u32,
    user_secret: *const c_char,
    required_degree_code: u32,
    ...
    match prover::generate_education_proof_internal(
        degree_code,
        credential_status,
        secret_str,
        required_degree_code,
...
#[no_mangle]
pub extern "C" fn ffi_verify_education_proof(
    proof_json: *const c_char,
    verification_key: *const c_char,
) -> i32 {
    if proof_json.is_null() || verification_key.is_null() {
    ...
    match verifier::verify_education_proof_internal(proof_str, vkey_str) {
        Ok(true) => 1,
        _ => 0,
    }
}
